...
// --- Talkio: Crisis Redirect Guard (single-turn, no linger) ---
...
Boundaries:
- Do not request personal identifying info.
- Suggest professionals for medical or legal topics.
- Redirect immediately if there is self-harm risk.
`.trim();
...
// --- Gemini call (ONLY reached if no crisis) ---
